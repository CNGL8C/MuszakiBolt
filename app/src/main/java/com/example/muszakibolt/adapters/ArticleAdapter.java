...
public class ArticleAdapter
    ...
    public void onBindViewHolder(ArticleViewHolder holder, int position) {
        ...
        if(holder.getBindingAdapterPosition() > lastPosition) {
            Animation animation = AnimationUtils.loadAnimation(context, R.anim.row_slide);
    ...
    class ArticleViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindTo(Article current){
            ...
            itemView.findViewById(R.id.add_to_cart).setOnClickListener(view -> ((ShoppingActivity)context).updateAlertIcon(current));
